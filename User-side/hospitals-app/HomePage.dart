              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("Select COVID-19 centre", style: TextStyle(
                        fontSize: 30,
                      ...
                      Container(
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            categoryContainer("category7.png", "Hospitals"),
                            categoryContainer("category2.png", "Testing"),
                            categoryContainer("category6.png", "Quarantine"),
                          ],
                        ),
                      ),
                      Text("Optimised Hospitals", style: TextStyle(
                        fontSize: 25,
                      ...
                      Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: <Widget>[
                              createDocWidget("doc1.png", "Aundh District Hospital"),
                              createDocWidget("doc2.png", "Dr Dalvi Hospital"),
                              createDocWidget("doc3.png", "Sassoon General Hospital"),
                            ],
                          ),
                        ),
                      )
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      width: 250,
                      height: 30,
                      child: Text("Check More", style: TextStyle(
                        fontSize: 12,
